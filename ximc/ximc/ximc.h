...
/** @cond DO_NOT_WANT */
#define LIBXIMC_VERSION 2.9.8
/** @endcond */


/** @cond DO_NOT_WANT */
#define LIBXIMC_PROTOCOL_VERSION 17.2
/** @endcond */
...
#define STATE_CURRENT_MOTOR_BITS       0xC0000 	/**< \english Flags of motor choice. \endenglish \russian Флаги выбора мотора. \endrussian */
...
/** 
	...
	*/
	typedef struct
	{
		unsigned int LowUpwrOff;	/**< \english Lower voltage limit to turn off the motor, in mV. \endenglish \russian Нижний порог напряжения на силовой части для выключения, в мВ. \endrussian */
		...
		unsigned int CriticalUpwr;	/**< \english Maximum motor voltage which triggers ALARM state, in mV. \endenglish \russian Максимальное напряжение на силовой части, вызывающее состояние ALARM, в мВ. \endrussian */
		...
		unsigned int CriticalUusb;	/**< \english Maximum USB voltage which triggers ALARM state, in mV. \endenglish \russian Максимальное напряжение на USB, вызывающее состояние ALARM, в мВ. \endrussian */
		unsigned int MinimumUusb;	/**< \english Minimum USB voltage which triggers ALARM state, in mV. \endenglish \russian Минимальное напряжение на USB, вызывающее состояние ALARM, в мВ. \endrussian */
...
/** 
	...
	* девайсов должно содержатьстроку "XIMC" (по нему производится валидация).
