...
const
	...
	STATE_ERRD                      = $00002;
	STATE_ERRV                      = $00004;
	STATE_EEPROM_CONNECTED          = $00010;
	STATE_IS_HOMED                  = $00020;
	STATE_SECUR                     = $3FFC0;
	STATE_ALARM                     = $00040;
	STATE_CTP_ERROR                 = $00080;
	STATE_POWER_OVERHEAT            = $00100;
	STATE_CONTROLLER_OVERHEAT       = $00200;
	STATE_OVERLOAD_POWER_VOLTAGE    = $00400;
	STATE_OVERLOAD_POWER_CURRENT    = $00800;
	STATE_OVERLOAD_USB_VOLTAGE      = $01000;
	STATE_LOW_USB_VOLTAGE           = $02000;
	STATE_OVERLOAD_USB_CURRENT      = $04000;
	STATE_BORDERS_SWAP_MISSET       = $08000;
	STATE_LOW_POWER_VOLTAGE         = $10000;
	STATE_H_BRIDGE_FAULT            = $20000;
	STATE_CURRENT_MOTOR_BITS        = $C0000;
	STATE_CURRENT_MOTOR0            = $00000;
	STATE_CURRENT_MOTOR1            = $40000;
	STATE_CURRENT_MOTOR2            = $80000;
	STATE_CURRENT_MOTOR3            = $C0000;
